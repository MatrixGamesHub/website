       ...
       <div class="panel panel-default">
             ...
             <div class="col-md-12" style="display:table-cell;vertical-align:middle;float: none;">
               <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">
                 <h4 class="panel-title">
                   I just want to play the games / create games for myself
                 </h4>
               </a>
             </div>
         ...
         <div id="collapse1" class="panel-collapse collapse">
           <div class="panel-body">
             This is the easiest way to start with Matrix Games because you can create or just play
             Matrix Games without a devolopment environment. For this we offer you a package with
             the windows binaries and the games, which are available as source code and are
             dynamically loaded by a game console. This allows you to customize existing games or
             create new ones. <br>
             Download and unpack the package and you are good to go. <br>
             <br>
             <a href="download/MatrixGames.zip" class="btn btn-primary" role="button"> Download </a>
           </div>
         </div>
       </div>
           ...
           <div class="row" style="display: table;table-layout: fixed;">
             <div class="col-md-12" style="display:table-cell;vertical-align:middle;float: none;">
               <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">
                 <h4 class="panel-title">
                   I want create games and share them with the community
                 </h4>
               </a>
             </div>
             <div class="col-md-12 text-right" style="display:table-cell;vertical-align:middle;float: none;">
         ...
         <div class="panel-heading">
           <div class="row" style="display: table;table-layout: fixed;">
             ...
             <div class="col-md-12 text-right" style="display:table-cell;vertical-align:middle;float: none;">
               <table>
                 <tr>
                   <td> <img src="images/develop-black-32.png"/> </td>
                   <td>&nbsp;&nbsp;</td>
                   <td> <img src="images/community-black-32.png"/> </td>
                   <td>&nbsp;&nbsp;</td>
                   <td> <img src="images/gamepad-black-32.png"/> </td>
